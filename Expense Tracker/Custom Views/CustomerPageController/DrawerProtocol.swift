...
//
//  Created by Abdirizak Hassan on 12/1/22.
//

import Foundation
import UIKit
public protocol PageControlDraw {
...
public class PageControlDrawerParentWithIndicator: PageControlDrawerParent {
...
public class PageControlDrawerParent {
